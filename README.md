...
This project leverag **AI-Driven Threat Validation**. I utilized generative AI as a technical consultant to source industry-standard attack vectors (Hydra/FIM) to stress-test this defensive architecture. This "Purple Team" approach ensures that the infrastructure I build is validated against real-world adversarial behavior.
